...
--		trail = 1,
		...
		x =      r * math.cos(a), xv = rng.float(-0.2, 0.2), xa = rng.float(-0.01, 0.01),
		y = -3 + r * math.sin(a), yv = rng.float(-0.7, -0.1), ya = -0.03,
		dir = dir, dirv = dirv, dira = dir / 20,
		vel = 0, velv = 0, vela = 0,

		r = rng.range(200, 245)/255,  rv = 0, ra = 0,
		g = rng.range(5, 15)/255,  gv = 0, ga = 0,
